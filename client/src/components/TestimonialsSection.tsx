...
const testimonials = [
  {
    ...
    rating: 5,
    text: "A blusa que comprei é simplesmente única. Cada detalhe bordado conta uma história. Recebi inúmeros elogios e me sinto completamente eu mesma usando.",
    product: "Blusa Arara Bordada",
    initial: "M",
    color: "#C4522A",
  },
  {
    ...
    rating: 5,
    text: "Nunca vi uma marca que captura tão bem a alma brasileira. O vestido chegou embalado com tanto carinho, parecia um presente. Qualidade impecável.",
    product: "Vestido Floresta",
    initial: "F",
    color: "#2D6A4F",
  },
  {
    ...
    rating: 5,
    text: "O colar Nativa é uma obra de arte. Artesanato brasileiro no seu melhor — original, vibrante e cheio de significado. Já indiquei para todas as amigas!",
    product: "Colar Nativa",
    initial: "J",
    color: "#1B7A8C",
  },
];
