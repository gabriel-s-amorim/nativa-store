...
export default function MelhorEnvioIntegrationCard() {
  ...
  if (loading || !form || !status) {
    return (
      <Card className="flex justify-center border-[var(--admin-border)] bg-[var(--admin-surface)] p-8 shadow-sm">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          <Card className="space-y-4 border-[var(--admin-border)] bg-[var(--admin-surface)] p-5 shadow-sm">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  onChange={e =>
                    setForm({
                      ...form,
                      senderDocumentType: e.target.value as "cpf" | "cnpj",
                    })
                  }
              ...
              <div className="space-y-2">
                <Label htmlFor="senderDocument">
                  {form.senderDocumentType === "cnpj" ? "CNPJ" : "CPF"}
                </Label>
                <Input
                  id="senderDocument"
                  value={form.senderDocument}
                  onChange={e =>
                    setForm({ ...form, senderDocument: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="senderStateRegister"
                  value={form.senderStateRegister}
                  onChange={e =>
                    setForm({ ...form, senderStateRegister: e.target.value })
                  }
                  placeholder="ISENTO"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setForm({ ...form, senderComplement: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setForm({ ...form, senderDistrict: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setForm({ ...form, senderCity: e.target.value })
                  }
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={e =>
                    setForm({
                      ...form,
                      senderStateAbbr: e.target.value.toUpperCase(),
                    })
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="mt-1 text-xs text-[var(--admin-text-muted)]">
                    Zera a opção mais barata quando o pedido atingir o valor
                    mínimo.
                  </p>
                </div>
                <Switch
